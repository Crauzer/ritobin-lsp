...
export type RitobinDocument = vscode.TextDocument & { languageId: "ritobin" };
export type RitobinEditor = vscode.TextEditor & { document: RitobinDocument };

export function isRitobinDocument(
  document: vscode.TextDocument,
): document is RitobinDocument {
...
): editor is RitobinEditor {
  return isRitobinDocument(editor.document);
}

export function isDocumentInWorkspace(document: RitobinDocument): boolean {
...
export const RUST_TOOLCHAIN_FILES = [
  "rust-toolchain.toml",
  "rust-toolchain",
] as const;
