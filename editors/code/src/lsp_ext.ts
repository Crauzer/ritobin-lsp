...
/**
 * This file mirrors `crates/ritobin-lsp/src/lsp_ext.rs` declarations.
 */

import * as lc from "vscode-languageclient";

// ritobin-lsp overrides
...
// ritobin-lsp extensions

export const unhash = new lc.RequestType<UnhashParams, lc.TextEdit[], void>(
  "ritobin-lsp/unhash",
);
...
export const analyzerStatus = new lc.RequestType<
  ...
  string,
  void
>("ritobin-lsp/analyzerStatus");
export const cancelFlycheck = new lc.NotificationType0(
  "ritobin-lsp/cancelFlycheck",
);
export const clearFlycheck = new lc.NotificationType0(
  "ritobin-lsp/clearFlycheck",
);
export const expandMacro = new lc.RequestType<
  ExpandMacroParams,
  ExpandedMacro | null,
  void
>("ritobin-lsp/expandMacro");
export const memoryUsage = new lc.RequestType0<string, void>(
  "ritobin-lsp/memoryUsage",
);
export const openServerLogs = new lc.NotificationType0(
  "ritobin-lsp/openServerLogs",
);
export const relatedTests = new lc.RequestType<
  lc.TextDocumentPositionParams,
  TestInfo[],
  void
>("ritobin-lsp/relatedTests");
export const reloadWorkspace = new lc.RequestType0<null, void>(
  "ritobin-lsp/reloadWorkspace",
);
export const rebuildProcMacros = new lc.RequestType0<null, void>(
  "ritobin-lsp/rebuildProcMacros",
);

export const runFlycheck = new lc.NotificationType<{
  textDocument: lc.TextDocumentIdentifier | null;
}>("ritobin-lsp/runFlycheck");
export const viewSyntaxTree = new lc.RequestType<
  ViewSyntaxTreeParams,
  string,
  void
>("ritobin-lsp/viewSyntaxTree");
export const viewCrateGraph = new lc.RequestType<
  ViewCrateGraphParams,
  string,
  void
>("ritobin-lsp/viewCrateGraph");
export const viewFileText = new lc.RequestType<
  lc.TextDocumentIdentifier,
  string,
  void
>("ritobin-lsp/viewFileText");
export const viewHir = new lc.RequestType<
  lc.TextDocumentPositionParams,
  string,
  void
>("ritobin-lsp/viewHir");
export const viewMir = new lc.RequestType<
  lc.TextDocumentPositionParams,
  string,
  void
>("ritobin-lsp/viewMir");
export const interpretFunction = new lc.RequestType<
  lc.TextDocumentPositionParams,
  string,
  void
>("ritobin-lsp/interpretFunction");
export const viewItemTree = new lc.RequestType<
  ViewItemTreeParams,
  string,
  void
>("ritobin-lsp/viewItemTree");
export const getFailedObligations = new lc.RequestType<
  lc.TextDocumentPositionParams,
  string,
  void
>("ritobin-lsp/getFailedObligations");

export type UnhashParams = {
...
export const fetchDependencyList = new lc.RequestType<
  ...
  void
>("ritobin-lsp/fetchDependencyList");
...
export const fetchDependencyGraph = new lc.RequestType<
  ...
  void
>("ritobin-lsp/fetchDependencyGraph");
...
export const viewRecursiveMemoryLayout = new lc.RequestType<
  ...
  void
>("ritobin-lsp/viewRecursiveMemoryLayout");
...
export type CargoRunnableArgs = {
  ...
  // extension directly, but that would prevent us from honoring the ritobin-lsp.toml for it.
